...
<div class="super_container">
	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="blog.php">Basarı Öyküleri</a></li>
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/tarif.jpg" alt="Elbistan diyetisyen" data-speed="0.8"></div>
										...
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul class="d-flex flex-row align-items-center justify-content-start">
													...
													<li><a href="blog.php">Basarı Öyküleri</a></li>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Basarı Öyküleri</div>
						</div>
					</div>
				</div>
			</div>
...
<?php 
	...
	<div class="news">
            <div class="container" >
			<?php  
				$vericek = $db->query("SELECT * FROM basari where basari_id=$id ", PDO::FETCH_ASSOC); 
				foreach($vericek as $row){	
					$row['basari_id'];
				?>
                 <img src="<?php echo $row["basari_resim"];?>" alt="" style="float:right;" width="40%" height="280px;"  />
                        <h1 style="color:black;font-size:38px;"><?php echo $row["basari_adi"];?></h1>
                        <p style="font-size:20px;"><?php echo $row["basari_icerik"];?></p>
						<?php
					}
				?>	
                    </div>  
