...
<html lang="tr">
<head>
<title>Elbistan Diyetisyen|Ayse Davdav|Diyet Tarifleri </title>
<meta charset="utf-8">
...
<div class="super_container">
	...
	<div class="home">
		<div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="images/tarif.jpg" data-speed="0.8"></div>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_title">Diyet Tarifleri</div>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
        <?php
        $sorgu = $baglanti->query("SELECT * FROM sayfalar where sayfa_kategori='Tarif' limit " . (($page - 1) * $sayfaBasinaKayitSayisi) . "," . $sayfaBasinaKayitSayisi);
        ...
        while ($sonuc = $sorgu->fetch_assoc()) { // verileri döngü ile sayfamıza yazıyoruz
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                <div style="margin-bottom:10px;" class="card"> 				
					<div class="card-body"><img src="<?php echo $sonuc["sayfa_resim"];?>" class="card-img-top"  width="80%;" height="200px;" alt="Elbistan diyetisyen" ></div>
					<div class="card-header"><?php echo $sonuc['sayfa_adi'] ?></div>
					<div class="card-footer">
					<?php echo "<a href='page.php?id=".$sonuc["sayfa_id"]." '>";?>					
					<p style="float:right;" class="btn btn-success">Devamını Oku »</p></a>					
					</div>
                </div> 
            </div> <!-- 1. hücre sonu-->
            <?php
